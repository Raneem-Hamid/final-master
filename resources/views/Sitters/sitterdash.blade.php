    ...
    <div class="main-panel">
        <div class="content-wrapper">
            <div class="row">
                ...
                @php
                    $sitter=App\Models\Sitter::find($app->sitters_id);
                    $child=App\Models\Children::find($app->children_id);
                    $user=App\Models\User::find($app->users_id);

                @endphp
                    
                @if ($sitter->users_id==Auth::user()->id)
                ...
                <div class="col-sm-4 grid-margin">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <img class="img-lg rounded-circle mr-3" src="{{asset('upload/image/'.$user->image)}}"
                                    alt="" />
                                    <h3 >{{$user->name}}</h3>
                            </div>
                            <div class="row mt-4">
                                <div class="col-8 col-sm-12 col-xl-8 my-auto">
                                    <div class="d-flex d-sm-block d-md-flex align-items-center">
                                        <h4 class="mb-0">The child Name:</h4>
                                        <h6 class=" ml-2 mb-0 font-weight-medium">
                                            {{$child->name}}
                                        </h6>
                                    </div>
                                </div>
                             ...
                             <div class="row mt-4">
                                <div class="col-8 col-sm-12 col-xl-8 my-auto">
                                    <div class="d-flex d-sm-block d-md-flex align-items-center">
                                        <h4 class="mb-0">The Child age:</h4>
                                        <h6 class=" ml-2 mb-0 font-weight-medium">
                                                                                        {{$child->age}}
                             ...
                             <div class="row mt-4">
                                <div class="col-8 col-sm-12 col-xl-8 my-auto">
                                    <div class="d-flex d-sm-block d-md-flex align-items-center">
                                        <h4 class="mb-0">The child Problems:</h4>
                                        <h6 class=" ml-2 mb-0 font-weight-medium">
                                                                                        {{$child->explain}}
                             ...
                             <div class="row mt-4">
                                <div class="col-8 col-sm-12 col-xl-8 my-auto">
                                    <div class="d-flex d-sm-block d-md-flex align-items-center">
                                        <h4 class="mb-0">Addres:</h4>
                                        <h6 class=" ml-2 mb-0 font-weight-medium">
                                            {{$app->city}} / {{$app->street}} / Building :{{$app->bulding}}
                                        </h6>
                                    </div>
                                </div>
                             ...
                             <div class="row mt-4 d-flex justify-content-around">
                                        ...
                                        <a class="btn btn-lg btn-danger" href="{{route('reject',$app->id)}}">Reject</a>
                                        <a class="btn btn-lg btn-success" href="{{route('accept',$sitter->id)}}">Acceptance</a>
